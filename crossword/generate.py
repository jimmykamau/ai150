...
class CrosswordCreator():
    ...
    def assignment_complete(self, assignment):
        ...
        """
        for variable in self.domains:
            if variable not in assignment.keys() or assignment[variable] is None:
                return False
        return True
    ...
    def consistent(self, assignment):
        ...
        for key, value in assignment.items():
            ...
            for word in neighbors:
                overlap = self.crossword.overlaps[key, word]
                if word in assignment:
                    if assignment[word][overlap[1]] != value[overlap[0]]:
                        return False
        return True
    ...
    def order_domain_values(self, var, assignment):
        ...
        """
        value_count = {value: 0 for value in self.domains[var]}
            ...
            if variable not in assignment:
                for value in value_count:
                    if value in self.domains[variable]:
                        value_count[value] += 1
        return sorted([x for x in value_count], key = lambda x: value_count[x])
    ...
    def select_unassigned_variable(self, assignment):
        ...
        return sorted(
            [variable for variable in unassigned],
    ...
    def backtrack(self, assignment):
        ...
        ordered = self.order_domain_values(unassigned, assignment)
